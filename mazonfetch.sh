...
_set_info()
{
	...
	inf[1]="${red}  $ql${reset}"
	inf[2]="${green}Distro     ${white}:${yallow} $f${reset}"
	inf[3]="${blue}OS         ${white}:${yallow} $f_os${reset}"
	inf[4]="${blue}Kernel Name${white}:${yallow} $f_kname${reset}"
	inf[5]="${blue}Kernel     ${white}:${yallow} $f_kv${reset}"
	inf[6]="${blue}Uptime     ${white}:${yallow} $f_uptime${reset}"
	inf[7]="${blue}Shell      ${white}:${yallow} $f_shell${reset}"
	inf[8]="${blue}Resolution ${white}:${yallow} $f_resolucao${reset}"
 	inf[9]="${blue}Desktop    ${white}:${yallow} $f_desk${reset}"
	inf[10]="${blue}Fonte      ${white}:${yallow} $f_font${reset}"
	inf[11]="${blue}CPU        ${white}:${yallow} $f_cpu $f_tcpu${reset}"
	inf[12]="${blue}Core(s)    ${white}:${yallow} $(nproc)${reset}"
	inf[13]="${blue}GPU        ${white}:${yallow} $f_gpu${reset}"
	inf[14]="${blue}Mem RAM    ${white}:${yallow} $(free -h | grep Mem | awk '{print $2 }')${reset}"
	inf[15]="${blue}Mem free   ${white}:${yallow} $(free -h | grep Mem | awk '{print $4 }')${reset}"
	inf[16]="${blue}Architetura${white}:${yallow} $f_ach${reset}"
	inf[17]="${blue}Browser    ${white}:${yallow} $f_nave${reset}"
}
